...
{
    public partial class frmCreateTech : Form
    {
        private string createdBy;
        public static frmCreateTech dgvRefresh;
        public frmCreateTech(string createdBy)
        {
            InitializeComponent();
            this.createdBy = createdBy;
            dgvRefresh = this;
        }
        Class1 CreateTech = new Class1("LAPTOP-751I04E4\\SQLEXPRESS", "CS311-2022", "trix", "12345");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
...

            {
                ...
                try
                {
                    ...
                    CreateTech.executeSQL("INSERT INTO tblTicket (TicketNumber, Problem, Details, Date, Time, status, createdBy, dateCompleted, dateAssigned, dateApproved ) VALUES ('" +
        ...
        private void frmCreateTech_Load(object sender, EventArgs e)
        {
            timer1.Start();
        }
