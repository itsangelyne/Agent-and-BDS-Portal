...
namespace CS311_2022_MIDTERM
{
    public partial class frmCreateAdmin : Form
    {
        ...
        public static frmCreateAdmin dgvRefresh;
        public frmCreateAdmin(string createdBy)
        {
            InitializeComponent();
            this.createdBy = createdBy;
            dgvRefresh = this;
        }
        Class1 CreateAdmin = new Class1("LAPTOP-751I04E4\\SQLEXPRESS", "CS311-2022", "trix", "12345");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
...

            {
                ...
                try
                {
                    ...
                    CreateAdmin.executeSQL("INSERT INTO tblTicket (TicketNumber, Problem, Details, Date, Time, status, createdBy, dateCompleted, dateAssigned, dateApproved ) VALUES ('" +
